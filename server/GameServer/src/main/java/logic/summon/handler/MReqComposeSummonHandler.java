...
@MHandler(messageClazz = C2SSummonMsg.ComposeSummon.class)
public class MReqComposeSummonHandler extends MessageHandler {
    ...
    public void action() throws AbstractLogicModelException {
        ...
        C2SSummonMsg.ComposeSummon msg = (C2SSummonMsg.ComposeSummon) getMessage().getData();
        SummonManager manager = player.getSummonManager();
        manager.reqComposeSummon(msg);
    }
