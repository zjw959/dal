...
public class CronSequenceGenerator {
    ...
    private void doNext(Calendar calendar, int dot) {
        ...
        int updateSecond = findNext(this.seconds, second, calendar, Calendar.SECOND,
                Calendar.MINUTE, emptyList);
    ...
    private int findNextDay(Calendar calendar, BitSet daysOfMonth, int dayOfMonth,
            BitSet daysOfWeek, int dayOfWeek, List<Integer> resets) {
    ...
    private void parse(String expression) throws IllegalArgumentException {
        String[] fields = StringUtil.tokenizeToStringArray(expression, " ", true, true);
    ...
    private String replaceOrdinals(String value, String commaSeparatedList) {
        String[] list = StringUtil.commaDelimitedListToStringArray(commaSeparatedList);
        for (int i = 0; i < list.length; i++) {
            String item = list[i].toUpperCase();
            value = StringUtil.replace(value.toUpperCase(), item, "" + i);
        }
        return value;
    }
    ...
    private void setMonths(BitSet bits, String value) {
        ...
        // Months start with 1 in Cron and 0 in Calendar, so push the values first into a longer
        // bit set
    ...
    private void setNumberHits(BitSet bits, String value, int min, int max) {
        String[] fields = StringUtil.delimitedListToStringArray(value, ",");
        for (String field : fields) {
            if (!field.contains("/")) {
                ...
                String[] split = StringUtil.delimitedListToStringArray(field, "/");
                if (split.length > 2) {
    ...
    public boolean equals(Object other) {
        ...
        return (this.months.equals(otherCron.months)
                ...
                && this.hours.equals(otherCron.hours) && this.minutes.equals(otherCron.minutes)
