 ...
 * @author beykery
 */
public abstract class BaseKcpClient implements Output, KcpListerner, Runnable {
            ...
            protected void initChannel(NioDatagramChannel ch) throws Exception {
                ...
                cp.addLast(new ChannelInboundHandlerAdapter() {
                    ...
                    public void channelRead(ChannelHandlerContext ctx, Object msg)
                        ...
                        BaseKcpClient.this.onReceive(dp);
                    }

                    @Override
                    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause)
                            throws Exception {
                        BaseKcpClient.this.handleException(cause, null);
                        BaseKcpClient.this.close();
                    }
                });
            }
        });
