...
public interface ICacheManager {
    ...
    void expireCache(final CacheKeyTO cacheKey, final CacheWrapper<Object> result, final Method method,
            final Object target, final Object args[]) throws CacheCenterConnectionException;
     ...
     * @throws CacheCenterConnectionException 缓存异常
     */
    CacheWrapper<Object> get(final CacheKeyTO key, final Method method, final Object target,
            final Object args[])
