...
public abstract class AbstractScriptParser {
     ...
     * @throws Exception 异常
     */
    public int getRealExpire(int expire, String expireExpression, Object target, Object[] arguments,
            Object result) throws Exception {
        Integer tmpExpire = null;
        if (null != expireExpression && expireExpression.length() > 0) {
            tmpExpire = this.getElValue(expireExpression, target, arguments, result, true,
                    Integer.class);
