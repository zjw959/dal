...
public class AutoLoadTO implements Serializable {
    ...
    /**
     * 缓存时长 该字段的作用是为了在对redis数据进行续期时 保证lastLoadTime表达的含义一直为从dao的加载时间
     */
    ...
    public AutoLoadTO(CacheKeyTO cacheKey, CacheAopProxyChain joinPoint, Object args[], Cache cache,
        ...
        this.cache = cache;
        this.expire = expire;
        this.expireAt = System.currentTimeMillis() + expire * 1000;
    }
     ...
     * @return this
     */
    public AutoLoadTO setExpireAt(long expireAt) {
