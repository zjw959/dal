...
public class NovelDatingCfgBean 
{
  private int id; // 
  ...
  private int[] roleReward; // 奖励指定精灵游戏资源 格式：精灵id-资源id-数量  目前只支持添加好感度，若后期有其他资源奖励，再做调整
  ...
  /**
   * get 奖励指定精灵游戏资源 格式：精灵id-资源id-数量  目前只支持添加好感度，若后期有其他资源奖励，再做调整
   * @return
   */
   public int[] getRoleReward()
   {
     return roleReward;
   }

  /**
   * set 奖励指定精灵游戏资源 格式：精灵id-资源id-数量  目前只支持添加好感度，若后期有其他资源奖励，再做调整
   */
   public void setRoleReward(int[] roleReward)
   {
