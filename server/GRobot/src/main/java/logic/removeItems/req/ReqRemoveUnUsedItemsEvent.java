...
import logic.removeItems.ReqRemoveItemOrder;

@IsEvent(eventT = EventType.REQUSET_REPEAT, functionT = FunctionType.REMOVEITEM,
        order = ReqRemoveItemOrder.REQ_REMOVE_UNUSEDITEMS)
