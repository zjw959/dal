...
@IsEvent(eventT = EventType.RESPONSE, functionT = FunctionType.NULL,
        order = S2CEquipmentMsg.TakeOffMsg.MsgID.eMsgID_VALUE)
public class RespEquipTakeOffEvent extends AbstractEvent {

    public RespEquipTakeOffEvent(RobotThread robot) {
        super(robot);
    }
    ...
    public void action(Object... obj) throws Exception {
        ...
        if (data.length > 0) {
            ...
            Log4jManager.getInstance().debug(robot.getWindow(),
                    "robot:" + robot.getName() + "响应装备卸下" + msg.getSuccess());
