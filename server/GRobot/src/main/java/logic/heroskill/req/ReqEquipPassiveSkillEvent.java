...
@IsEvent(eventT = EventType.REQUSET_REPEAT, functionT = FunctionType.HERO_SKILL,
        order = ReqHeroSkillOrder.REQ_EQUIP_PASSIVE_SKILL)
public class ReqEquipPassiveSkillEvent extends AbstractEvent {

    public ReqEquipPassiveSkillEvent(RobotThread robot) {
